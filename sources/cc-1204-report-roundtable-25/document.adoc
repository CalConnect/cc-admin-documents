...
Following the BOF on ``VTODO``s, a `VTODO` Ad Hoc Committee was formed to examine requirements and
ongooing work on ``VTODO``s and recommend future activity in this area to CalConnect. The Ad Hoc
