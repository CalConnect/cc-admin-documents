...
Much of the ongoing work in CalConnect is focused on specifications to become internet draft submissions to the IETF and ultimately be progressed to become RFCs
...
NOTE: Please note that CalConnect documents at the IETF are mentioned only if their status has changed or they have been updated since the last
CalConnect event
